  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="inheritanceH.jsp">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Weights related to the inheritance factor</h1>
          </div>
          ...
          <!-- /.container-fluid -->
			...
			<form>
						<table class="table table-bordered">
							<thead>
								<tr>
									<th scope="col">Inheritance Pattern</th>
							...
							<tbody>
								<tr>
									...
									<td><input type="text" id="no_inherit" name="no_inherit"></td>
						...
						<input type="button" name="inheritsave" id="inheritsave" value="SAVE" class="btn btn-success">
				</form>

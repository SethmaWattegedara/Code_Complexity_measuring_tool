      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Inheritance:</h1>
          </div>
          ...
          <!-- /.container-fluid -->
        	...
        	<form action = "InheritanceServlet" method="post" enctype="multipart/form-data">
        	...
        	<div class = "upload-box" style = "display: block;margin-left: auto;margin-right: auto; width: 90%; height: 300px; border: 3px solid #007284; border-radius: 25px;">
        	
            	<input type="file" id="files" name="filename" multiple="multiple" accept = ".zip, .java, .cpp" style = "display: block;margin-left: auto;margin-right: auto;align-content: center;"/>
            	</div>
            	<p style="text-align: right; margin-top: 2%;margin-right: 5%;">
                <input type="submit" value="Upload" class="btn btn-lg btn-primary" name="upload">
            	</p>
